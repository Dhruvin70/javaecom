                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <input type="text" id="form3Example1" class="form-control ps-2"
                                                        placeholder="John" required="required" name="first"/>
                                                    <label class="form-label ps-2" for="form3Example1">First
                                                        name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <input type="text" id="form3Example2" class="form-control ps-2"
                                                        placeholder="Smith" required="required" name="last"/>
                                                    <label class="form-label ps-2" for="form3Example2">Last name</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3 ">
                                                ...
                                                <div class="form-outline form-white">
                                                    ...
                                                    <select name="countryCode" required="required" id="countryCode"
                                                        class="form-control form-control ps-2" >
                                                    ...
                                                    <label class="form-label ps-2" for="form3Examplea7">Country Code
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-md-8 mb-3 ">
                                                ...
                                                <div class="form-outline form-white">
                                                    <input type="tel" id="form3Examplea8" class="form-control ps-2"
                                                        placeholder="123 456 7890" required="required" name="phone"/>

                                                    <label class="form-label ps-2" for="form3Examplea8">Phone
                                                        Number</label>
                                                </div>
                                            ...
                                            <div class="form-outline mb-3">
                                                <input type="text" id="form3Example3" class="form-control ps-2"
                                                    placeholder="Your Company" required="required" name="companyname"/>
                                                <label class="form-label ps-2" for="form3Example3">Company Name</label>
                                            </div>

                                            <!-- Company Address -->
                                            <div class="form-outline mb-3">
                                                <input type="text" id="form3Example3" class="form-control ps-2"
                                                    placeholder="XYZ Street Name, City Name, XYZ123, Country " required="required" name="address" />
                                                <label class="form-label ps-2" for="form3Example3">Address</label>
                                            </div>

                                            <!-- Email input -->
                                            <div class="form-outline mb-3">
                                                <input type="email" id="form3Example3" class="form-control ps-2"
                                                    placeholder="xyz@domain.com" required="required" name="email"/>
                                                <label class="form-label ps-2" for="form3Example3">Email address</label>
                                            </div>

                                            <!-- Password input -->
                                            <div class="form-outline mb-3">
                                                <input type="password" id="form3Example4" class="form-control ps-2" required="required" name="password" />
                                            ...
                                            <div class="form-outline mb-3">
                                                <input type="password" id="form3Example4cdg"
                                                    class="form-control ps-2" required="required" name="repassword"/>
                                                <label class="form-label ps-2" for="form3Example4cdg">Repeat your
                                                    password</label>
                                            </div>
                                           ...
                                           <p class="form-outline ms-2" style="color:red;">${message}</p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 justify-content-center mb-3 mb-lg-4 mx-auto">
                                                    <button type="submit"
