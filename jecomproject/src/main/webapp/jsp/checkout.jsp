							...
							<div class="col-md-6 col-lg-4  mb-4 mb-md-0">
								<form>
									...
									<div class=" ms-4 d-flex flex-row">
										...
										<a type=button class="text-start rounded border w-100 p-3 btn btn-outline-primary text-decoration-none">
											<svg xmlns="http://www.w3.org/2000/svg" 
												height="16"  class="bi bi-paypal" 
												viewBox="0 0 16 16">
  <path
...
</svg><span class="ms-2" >PayPal</span>
										</a>
									</div>
